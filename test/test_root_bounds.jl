...
@testset verbose = true "Root bounds for networks" begin
    @testset "Small example" begin
        ...
        @test lower_bound_of_maximal_positive_steady_state_count(rn, num_a_b_attempts=5, num_h_attempts_per_a_b=5).bound == 3
    ...
    @testset "1-site phosphorylation" begin
        ...
        h = zeros(Int, 7)
        @test_throws VerticalRootCounts.NongenericDirectionError (
            toric_lower_bound_of_maximal_positive_root_count_fixed_b_h(A, F, b, h)
        )
